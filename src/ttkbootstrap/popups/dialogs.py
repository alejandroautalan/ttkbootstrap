"""
    ...
    used to create custom popups for the end user.
...
class QueryDialog(Dialog):
    """A simple modal dialog class that can be used to build simple
    data input popups. Displays a prompt, and input box, and a set of
...
class DatePickerDialog:
    ...
    ![](../../assets/popups/date-picker-dialog.png)
...
class FontDialog(Dialog):
    ...
    ![](../../assets/popups/querybox-get-font.png)
    """
...
class Messagebox:
    ...
    def show_info(message, title=" ", parent=None, alert=False, **kwargs):
        ...
        ![](../../assets/popups/messagebox-show-info.png)
    ...
    def show_warning(message, title=" ", parent=None, alert=True, **kwargs):
        ...
        ![](../../assets/popups/messagebox-show-warning.png)
    ...
    def show_error(message, title=" ", parent=None, alert=True, **kwargs):
        ...
        ![](../../assets/popups/messagebox-show-error.png)
    ...
    def show_question(
        ...
        **kwargs,
        ...
        ![](../../assets/popups/messagebox-show-question.png)
    ...
    def ok(message, title=" ", alert=False, parent=None, **kwargs):
        ...
        ![](../../assets/popups/messagebox-ok.png)
    ...
    def okcancel(message, title=" ", alert=False, parent=None, **kwargs):
        ...
        ![](../../assets/popups/messagebox-ok-cancel.png)
    ...
    def yesno(message, title=" ", alert=False, parent=None, **kwargs):
        ...
        ![](../../assets/popups/messagebox-yes-no.png)
    ...
    def yesnocancel(message, title=" ", alert=False, parent=None, **kwargs):
        ...
        ![](../../assets/popups/messagebox-yes-no-cancel.png)
    ...
    def retrycancel(message, title=" ", alert=False, parent=None, **kwargs):
        ...
        ![](../../assets/popups/messagebox-retry-cancel.png)
...
class Querybox:
    ...
    def get_color(
        ...
        ![](../../assets/popups/querybox-get-color.png)
    ...
    def get_date(
        ...
        ![](../../assets/popups/querybox-get-date.png)
    ...
    def get_string(
        ...
        ![](../../assets/popups/querybox-get-string.png)
    ...
    def get_integer(
        ...
        **kwargs,
        ...
        ![](../../assets/popups/querybox-get-integer.png)
    ...
    def get_float(
        ...
        **kwargs,
        ...
        ![](../../assets/popups/querybox-get-float.png)
